...
<head>
    ...
    <title>Post Management - The Journal</title>
...
<body>
    ...
    <div class="main">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2 class="fw-bold">Post Management</h2>
            <a href="{{ route('admin.posts.create') }}" class="btn btn-dark"><i class="bi bi-plus-lg me-1"></i> Add New
                Post</a>
        </div>
                    ...
                    <tbody>
                        @foreach ($posts as $post)
                            <tr>
                                ...
                                <td class="">
                                    <a href="{{ route('admin.posts.edit', $post->id) }}" class="btn btn-sm btn-outline-primary me-1"><i
