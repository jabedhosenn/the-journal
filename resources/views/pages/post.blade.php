        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-8 animate-fade-up">
                    <h1 class="display-4 fw-bold mb-3">Post</h1>
                    <p class="lead text-muted">Latest tech trends and innovations — Explore posts in this collection.
                    </p>
                </div>
            </div>
        </div>
